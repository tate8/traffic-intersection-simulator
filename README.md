...
of concerns. In this case, the view (a React component) doesn't have to worry about how the model (A TypeScript class) works and vice-versa. I probably spent closer to 8 hours than 4 on this. The nice thing about this way of implementing it is that with more time you could make the view look a lot better. For example, you could animate real cars going through the traffic stop and toggle sensors when the cars overlap with them.
